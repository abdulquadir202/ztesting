jQuery(document).ready(function(e) {
    function t(t) {
        t.each(function() {
            ...
            t.addClass("loaded"), i.timelineNavigation.on("click", ".next", function(e) {
                e.preventDefault(), n(i, a, "next")
            }), i.timelineNavigation.on("click", ".prev", function(e) {
                e.preventDefault(), n(i, a, "prev")
            }), i.eventsWrapper.on("click", "a", function(t) {
                t.preventDefault(), i.timelineEvents.removeClass("selected"), e(this).addClass("selected"), d(e(this)), s(e(this), i.fillingLine, a), f(e(this), i.eventsContent)
                ...
                "37" == e.which && h(t.get(0)) ? r(i, a, "prev") : "39" == e.which && h(t.get(0)) && r(i, a, "next")
            })
        })
    }

    function n(e, t, n) {
        var i = v(e.eventsWrapper),
            r = Number(e.timelineWrapper.css("width").replace("px", ""));
        "next" == n ? l(e, i - r + y, r - t) : l(e, i + r - y)
    }

    function r(e, t, n) {
        var i = e.eventsContent.find(".selected"),
            r = "next" == n ? i.next() : i.prev();
        if (r.length > 0) {
            var l = e.eventsWrapper.find(".selected"),
                o = "next" == n ? l.parent("li").next("li").children("a") : l.parent("li").prev("li").children("a");
            s(o, e.fillingLine, t), f(o, e.eventsContent), o.addClass("selected"), l.removeClass("selected"), d(o), a(n, o, e)
        }
    }
    ...
    function a(e, t, n) {
        var i = window.getComputedStyle(t.get(0), null),
            ...
            s = Number(n.eventsWrapper.css("width").replace("px", "")),
            o = v(n.eventsWrapper);
        ("next" == e && r > a - o || "prev" == e && -o > r) && l(n, -r + a / 2, a - s)
    }

    function l(e, t, n) {
        var i = e.eventsWrapper.get(0);
        t = t > 0 ? 0 : t, t = "undefined" != typeof n && n > t ? n : t, c(i, "translateX", t + "px"), 0 == t ? e.timelineNavigation.find(".prev").addClass("inactive") : e.timelineNavigation.find(".prev").removeClass("inactive"), t == n ? e.timelineNavigation.find(".next").addClass("inactive") : e.timelineNavigation.find(".next").removeClass("inactive")
    }
    ...
    function p(e, t) {
        var n = m(e.timelineDates[0], e.timelineDates[e.timelineDates.length - 1]),
            ...
            i = Math.round(i) + 4,
            r = i * t;
        return e.eventsWrapper.css("width", r + "px"), s(e.eventsWrapper.find("a.selected"), e.fillingLine, r), a("next", e.eventsWrapper.find("a.selected"), e), r
    }
    ...
    function f(e, t) {
        ...
        if (r.index() > i.index()) var l = "selected enter-right",
            s = "leave-left";
        else var l = "selected enter-left",
            s = "leave-right";
    ...
    function u(t) {
        ...
        return t.each(function() {
            ...
            if (i.length > 1) var r = i[0].split("/"),
                a = i[1].split(":");
            else if (i[0].indexOf(":") >= 0) var r = ["2000", "0", "0"],
                a = i[0].split(":");
    ...
    var x = e(".cd-horizontal-timeline"),
        y = 60;
    x.length > 0 && t(x)
});