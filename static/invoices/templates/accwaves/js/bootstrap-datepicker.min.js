    ...
    l.prototype = {
        ...
        _process_options: function(s) {
            ...
            if (n.startDate !== -1 / 0 && (n.startDate = n.startDate ? n.startDate instanceof Date ? this._local_to_utc(this._zero_time(n.startDate)) : D.parseDate(n.startDate, o, n.language) : -1 / 0), 1 / 0 !== n.endDate && (n.endDate = n.endDate ? n.endDate instanceof Date ? this._local_to_utc(this._zero_time(n.endDate)) : D.parseDate(n.endDate, o, n.language) : 1 / 0), n.daysOfWeekDisabled = n.daysOfWeekDisabled || [], t.isArray(n.daysOfWeekDisabled) || (n.daysOfWeekDisabled = n.daysOfWeekDisabled.split(/[,\s]*/)), n.daysOfWeekDisabled = t.map(n.daysOfWeekDisabled, function(t) {
                ...
                var h = [];
                h.push(D.parseDate(n.datesDisabled, o, n.language)), n.datesDisabled = h
            }
        ...
        fill: function() {
            ...
            if (!isNaN(n) && !isNaN(r)) {
                ...
                if (t.each(this.dates, function(t, e) {
                    ...
                    }), (o > n || n > l) && _.addClass("disabled"), n === o && _.slice(0, h).addClass("disabled"), n === l && _.slice(d + 1).addClass("disabled"), this.o.beforeShowMonth !== t.noop) {
                    var U = this;
                ...
                for (var F, S = t.map(this.dates, function(t) {
                    ...
                    }), x = -1; 11 > x; x++) F = ["year"], -1 === x ? F.push("old") : 10 === x && F.push("new"), -1 !== t.inArray(n, S) && F.push("active"), (o > n || n > l) && F.push("disabled"), y += '<span class="' + F.join(" ") + '">' + n + "</span>", n += 1;
                M.html(y)
            }
        },
        ...
        u = function(a) {
            ...
            return this.each(function() {
                ...
                if (!h) {
                    ...
                    } else n.data("datepicker", h = new l(this, D))
                }
        ...
        D = {
            ...
            parseDate: function(i, s, n) {
                ...
                if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(i)) {
                    for (i = new Date, d = 0; d < u.length; d++) switch (o = c.exec(u[d]), h = parseInt(o[1]), o[2]) {
                        case "d":
                            i.setUTCDate(i.getUTCDate() + h);
                            break;
                        case "m":
                            i = l.prototype.moveMonth.call(l.prototype, i, h);
                            break;
                        case "w":
                            i.setUTCDate(i.getUTCDate() + 7 * h);
                            break;
                        case "y":
                            i = l.prototype.moveYear.call(l.prototype, i, h)
                    }
                ...
                if (u.length !== w.length && (w = t(w).filter(function(e, a) {
                    ...
                    for (d = 0, k = w.length; k > d; d++) {
                        if (p = parseInt(u[d], 10), o = w[d], isNaN(p)) switch (o) {
                            case "MM":
            ...
            formatDate: function(e, a, i) {
                ...
                for (var n = t.extend([], a.separators), r = 0, o = a.parts.length; o >= r; r++) n.length && e.push(n.shift()), e.push(s[a.parts[r]]);
                return e.join("")
            },
